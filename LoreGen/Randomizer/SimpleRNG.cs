...
namespace LoreGen.Randomizer
{
    ...
    public class SimpleRNG
    {
        ...
        /// </summary>
        /// <param name="u">first seed</param>
        /// <param name="v">second seed</param>
        ...
        /// </summary>
        /// <returns>uniform random sample from the open interval (0, 1)</returns>
        ...
        /// </summary>
        /// <returns>Get normal (Gaussian) random sample with mean 0 and standard deviation 1</returns>
        ...
        /// Get normal (Gaussian) random sample with specified mean and standard deviation
        /// </summary>
        /// <param name="mean">specified mean</param>
        /// <param name="standardDeviation">standard deviation</param>
        /// <returns>Get normal (Gaussian) random sample with specified mean and standard deviation</returns>
        ...
        /// Get exponential random sample with mean 1
        /// </summary>
        /// <returns>Get exponential random sample with mean 1</returns>
        ...
        /// </summary>
        /// <param name="mean">specified mean</param>
        /// <returns>Get exponential random sample with specified mean</returns>
        ...
        /// </summary>
        /// <param name="degreesOfFreedom">n degrees of freedom</param>
        /// <returns>ChiSquare</returns>
